...
class Welcome(QMainWindow):
    ...
    def initUI(self, port, baud, size, parity, stop):
        ...
        self.calado = calado.Mesa(port = port, baudrate = baud, bytesize = size, parity = parity, stopbits = stop)
        self.new_wind()
...
import calado3 as calado

if __name__ == '__main__':  
    #robo = roboteste.calado()
